...
export const ASSETS = [
  ...
  // ---------------- 玄関 ----------------
  { p: 'rooms/01_entrance/mat.png', r: 'prop', ar: [2, 1], s: 'worn western entrance mat, faded floral border', use: '装飾' },
  ...
  { p: 'rooms/02_corridor/boot_scraper.png', r: 'prop', ar: [3, 2], s: 'cast iron boot scraper and a coarse bristle brush on a low wooden stand', use: '指示の対象（泥を落とす）' },
  ...
  { p: 'rooms/03_gunroom/ammo_box.png', r: 'prop', ar: [3, 2], s: 'open wooden ammunition box with brass cartridges, leather strap', use: '指示の対象（弾丸を置く）' },
  ...
  { p: 'rooms/04_wardrobe/shoe_shelf.png', r: 'prop', ar: [2, 1], s: 'low wooden shelf for shoes, empty, one shoehorn hanging', use: '指示の対象（靴）' },
  { p: 'rooms/04_wardrobe/coat_discarded.png', r: 'prop', ar: [2, 1], s: 'dark western overcoat and a pair of leather shoes discarded in a heap on the floor', use: '★復路の誘惑（拾えば腹が満ちるが重くなる）' },
  ...
  { p: 'rooms/06_kitchendoor/greens_basket.png', r: 'prop', ar: [4, 3], s: 'wicker basket of salted leafy greens, wilted, resting on the floor', use: '伏線（菜っ葉＝原作準拠）' },
